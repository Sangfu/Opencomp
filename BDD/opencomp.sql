...
--
-- Serveur: localhost
-- Généré le : Mar 17 Mai 2011 à 19:03
...
CREATE TABLE IF NOT EXISTS `classrooms_users` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `user_id` int(10) unsigned NOT NULL,
  `classrooms_id` int(10) unsigned NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;
...
(6, 5, 3, 4, 'Raconter, décrire, exposer'),
(4, NULL, 1, 48, 'Français'),
(5, 4, 2, 9, 'Langage oral'),
(7, 5, 5, 6, 'Échanger, débattre'),
(8, 5, 7, 8, 'Réciter'),
(9, 4, 10, 11, 'Lecture'),
...
CREATE TABLE IF NOT EXISTS `competences_users` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `competences_id` int(10) unsigned NOT NULL,
  `user_id` int(10) unsigned NOT NULL,
  `classroom_id` int(10) unsigned NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;
...
--
-- Contenu de la table `competences_users`
--
...
CREATE TABLE IF NOT EXISTS `establishments_users` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `user_id` int(10) unsigned NOT NULL,
...
--
-- Contenu de la table `establishments_users`
--
...
CREATE TABLE IF NOT EXISTS `tutors` (
  ...
  `postcode` int(5) NOT NULL,
  `town` varchar(50) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL,
  `tel` int(10) NOT NULL,
...
INSERT INTO `users` (`id`, `username`, `password`, `first_name`, `name`, `email`, `role`) VALUES
